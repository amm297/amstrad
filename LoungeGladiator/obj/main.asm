...
; This file was generated Fri Oct 23 09:22:38 2015
;--------------------------------------------------------
	.module main
	.optsdcc -mz80
...
00147$:
	...
	jr	NZ,00130$
00107$:
;src/CalcColision.h:94: cpct_clearScreen(0);
	ld	hl,#0x4000
	push	hl
	xor	a, a
	push	af
...
;src/CalcColision.h:95: map+=1;
	ld	hl, #_map+0
	inc	(hl)
;src/CalcColision.h:96: drawMap(map);
	ld	a,(_map)
	push	af
	inc	sp
	call	_drawMap
...
00130$:
	...
	pop	ix
	ret
;src/CalcColision.h:100: u8 checkArrowCollisions(){
;	---------------------------------
...
_checkArrowCollisions::
	...
	add	hl,sp
	ld	sp,hl
;src/CalcColision.h:103: if(    scene[(object.y)/tileheight][(object.x)/tilewidth] == 1
	...
	ld	h,a
	ld	a,(hl)
;src/CalcColision.h:108: object.x=object.lx;
;src/CalcColision.h:109: object.y=object.ly;
;src/CalcColision.h:103: if(    scene[(object.y)/tileheight][(object.x)/tilewidth] == 1
	ld	-12 (ix), a
	dec	a
	jp	Z,00101$
;src/CalcColision.h:104: || scene[(object.y)/tileheight][(object.x+tilewidth-1)/tilewidth] == 1
	ld	b,#0x00
	ld	hl,#0x0003
	add	hl,bc
	ld	-4 (ix),l
...
00113$:
	...
	dec	a
	jp	Z,00101$
;src/CalcColision.h:105: || scene[(object.y+6)/tileheight][(object.x)/tilewidth] == 1
	ld	e,-13 (ix)
	ld	d,#0x00
	ld	hl,#0x0006
	add	hl,de
...
00114$:
	...
	dec	a
	jr	Z,00101$
;src/CalcColision.h:106: || scene[(object.y+6)/tileheight][(object.x+tilewidth-1)/tilewidth] == 1
	ld	-6 (ix),c
	ld	-5 (ix),b
	ld	a,-13 (ix)
	or	a, a
...
;src/CalcColision.h:109: object.y=object.ly;
	...
	ld	(#(_object + 0x0001)),a
;src/CalcColision.h:111: return bound;
	ld	l,#0x01
	jp	00111$
00102$:
;src/CalcColision.h:114: if(    scene[(object.y)/tileheight][(object.x)/tilewidth] == 9
	ld	a,-12 (ix)
	sub	a, #0x09
	jp	Z,00106$
;src/CalcColision.h:115: || scene[(object.y)/tileheight][(object.x+tilewidth-1)/tilewidth] == 9
	ld	l,-4 (ix)
	ld	h,-3 (ix)
	ld	a,-11 (ix)
	or	a, a
...
00117$:
	...
	sub	a, #0x09
	jp	Z,00106$
;src/CalcColision.h:116: || scene[(object.y+6)/tileheight][(object.x)/tilewidth] == 9
	ld	l, c
	ld	h, b
	ld	a,-13 (ix)
	or	a, a
...
00118$:
	...
	sub	a, #0x09
	jr	Z,00106$
;src/CalcColision.h:117: || scene[(object.y+6)/tileheight][(object.x+tilewidth-1)/tilewidth] == 9
	ld	a,-13 (ix)
	or	a, a
	jr	Z,00119$
	ld	c,-8 (ix)
...
00120$:
	...
	jr	NZ,00107$
00106$:
;src/CalcColision.h:119: object.x=object.lx;
	ld	a, (#(_object + 0x0002) + 0)
	ld	(#_object),a
;src/CalcColision.h:120: object.y=object.ly;
	ld	a, (#(_object + 0x0003) + 0)
	ld	(#(_object + 0x0001)),a
;src/CalcColision.h:122: return bound;
	ld	l,#0x01
	jr	00111$
00107$:
;src/CalcColision.h:125: return bound;
	ld	l,#0x00
00111$:
	ld	sp, ix
	pop	ix
...
;src/main.c:41: cpct_setPalette(g_palette,4);
	...
	inc	sp
	ret
;src/main.c:44: void initPlayer(u8 p){
;	---------------------------------
; Function initPlayer
; ---------------------------------
_initPlayer::
...
;src/main.c:46: player.x = origins[p-1][0];
	ld	de,#_origins+0
	ld	l,4 (ix)
	dec	l
	ld	h,#0x00
	...
	ld	a,(bc)
	ld	(#_player),a
;src/main.c:47: player.y = origins[p-1][1];
	ld	e, c
	ld	d, b
	inc	de
	ld	a,(de)
	ld	(#(_player + 0x0001)),a
;src/main.c:48: player.lx = origins[p-1][0];
	ld	a,(bc)
	ld	(#(_player + 0x0002)),a
;src/main.c:49: player.ly = origins[p-1][1];
	ld	a,(de)
	ld	(#(_player + 0x0003)),a
...
;src/main.c:55: player.bullets = 3;
	...
	pop	ix
	ret
;src/main.c:58: void initEnemies(u8 p){
;	---------------------------------
...
;src/main.c:60: enemy.x = origins[p-1][2];
	ld	de,#_origins+0
	ld	l,4 (ix)
	dec	l
	ld	h,#0x00
	...
	ld	a,(bc)
	ld	(#_enemy),a
;src/main.c:61: enemy.y = origins[p-1][3];
	inc	de
	inc	de
	inc	de
	ld	a,(de)
	ld	(#(_enemy + 0x0001)),a
;src/main.c:62: enemy.lx = origins[p-1][2];
	ld	a,(bc)
	ld	(#(_enemy + 0x0002)),a
;src/main.c:63: enemy.ly = origins[p-1][3];
	ld	a,(de)
	ld	(#(_enemy + 0x0003)),a
;src/main.c:64: enemy.ox = origins[p-1][2];
	ld	a,(bc)
	ld	(#(_enemy + 0x0004)),a
;src/main.c:65: enemy.oy = origins[p-1][3];
	ld	a,(de)
	ld	(#(_enemy + 0x0005)),a
...
;src/main.c:70: enemy.room = 3;
	...
	pop	ix
	ret
;src/main.c:74: void initNivel(){
;	---------------------------------
; Function initNivel
; ---------------------------------
_initNivel::
;src/main.c:75: n.num=0;
	ld	hl,#_n+0
	ld	(hl),#0x00
;src/main.c:76: n.corazon=0;
	ld	hl,#_n + 1
	ld	(hl),#0x00
;src/main.c:77: n.bullet=0;
	ld	hl,#_n + 2
	ld	(hl),#0x00
	ret
;src/main.c:80: void initVariables(){
;	---------------------------------
; Function initVariables
; ---------------------------------
_initVariables::
;src/main.c:81: bound =0;
	ld	hl,#_bound + 0
	ld	(hl), #0x00
;src/main.c:82: temp = 0;
	ld	hl,#_temp + 0
	ld	(hl), #0x00
;src/main.c:83: map = 1;
	ld	hl,#_map + 0
	ld	(hl), #0x01
;src/main.c:84: arrow =0;
	ld	hl,#_arrow + 0
	ld	(hl), #0x00
;src/main.c:85: finish =0;
	ld	hl,#_finish + 0
	ld	(hl), #0x00
;src/main.c:86: following =0;
	ld	hl,#_following + 0
	ld	(hl), #0x00
;src/main.c:87: archer = 0;
	ld	hl,#_archer + 0
	ld	(hl), #0x00
;src/main.c:88: dead =0;
	ld	hl,#_dead + 0
	ld	(hl), #0x00
	ret
;src/main.c:92: void gameOver(){
;	---------------------------------
; Function gameOver
; ---------------------------------
_gameOver::
;src/main.c:94: cpct_clearScreen(0);
	ld	hl,#0x4000
	push	hl
	xor	a, a
	push	af
	...
	push	hl
	call	_cpct_memset
;src/main.c:95: memptr = cpct_getScreenPtr(VMEM,10,10);
	ld	hl,#0x0A0A
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:96: cpct_drawStringM0("Lounge Gladiator",memptr,1,0);
	ex	de,hl
	ld	bc,#___str_0+0
	ld	hl,#0x0001
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:98: memptr = cpct_getScreenPtr(VMEM,2,180);
	ld	hl,#0xB402
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:99: cpct_drawStringM0("Pulsa cualquier tecla",memptr,1,0);
	ex	de,hl
	ld	bc,#___str_1+0
	ld	hl,#0x0001
	push	hl
...
;src/main.c:103: if(cpct_isAnyKeyPressed()) return;
...
_menu::
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:110: int init = 50;
	ld	hl,#0x0032
	ex	(sp), hl
;src/main.c:111: int pushed =0;
	ld	-4 (ix),#0x00
	ld	-3 (ix),#0x00
;src/main.c:112: int cont =0;
	ld	de,#0x0000
;src/main.c:113: cpct_clearScreen(0);
	push	de
	ld	hl,#0x4000
	push	hl
	xor	a, a
	...
	call	_cpct_getScreenPtr
	pop	de
;src/main.c:116: cpct_drawStringM0("Lounge Gladiator",memptr,1,0);
	ld	c, l
	ld	b, h
	push	de
	ld	hl,#0x0001
	...
	call	_cpct_getScreenPtr
	pop	de
;src/main.c:120: cpct_drawStringM0("Nueva Partida",memptr,1,0);
	ld	c, l
	ld	b, h
	push	de
	ld	hl,#0x0001
	...
	call	_cpct_getScreenPtr
	pop	de
;src/main.c:123: cpct_drawStringM0("Creditos",memptr,1,0);
	ld	c, l
	ld	b, h
	push	de
	ld	hl,#0x0001
...
;src/main.c:116: cpct_drawStringM0("Lounge Gladiator",memptr,1,0);
	ld	-2 (ix),l
	ld	-1 (ix),h
;src/main.c:126: cpct_drawStringM0("Salir",memptr,1,0);
	ld	bc,#___str_5
	push	de
	ld	hl,#0x0001
	push	hl
...
00118$:
;src/main.c:134: cpct_scanKeyboard();
	push	de
...
00162$:
	jp	P,00102$
;src/main.c:136: cpct_drawSolidBox(memptr, 0, 2, 8);
	ld	hl,#0x0802
	push	hl
	xor	a, a
	push	af
	...
	pop	af
	inc	sp
;src/main.c:137: pushed ++;
	inc	-4 (ix)
	jr	NZ,00163$
	inc	-3 (ix)
00163$:
;src/main.c:138: cont =0;
	ld	de,#0x0000
00102$:
;src/main.c:140: if(cpct_isKeyPressed(Key_CursorUp) && cont > 150){
	push	de
	ld	hl,#0x0100
	call	_cpct_isKeyPressed
	ld	a,l
...
00164$:
	jp	P,00105$
;src/main.c:141: cpct_drawSolidBox(memptr, 0, 2, 8);
	ld	hl,#0x0802
	push	hl
	xor	a, a
	push	af
	...
	pop	af
	inc	sp
;src/main.c:142: pushed --;
	ld	l,-4 (ix)
	ld	h,-3 (ix)
	dec	hl
	ld	-4 (ix),l
	ld	-3 (ix),h
;src/main.c:143: cont = 0;
	ld	de,#0x0000
00105$:
;src/main.c:146: switch (pushed){
	ld	a,-3 (ix)
	rlca
	and	a,#0x01
	ld	b,a
...
00165$:
	...
	add	hl,de
	add	hl,de
;src/main.c:147: case 0: init = 50;break;
	pop	de
	jp	(hl)
00166$:
	jr	00107$
...
00107$:
	...
	ex	(sp), hl
	jr	00110$
;src/main.c:148: case 1: init = 70;break;
00108$:
	ld	hl,#0x0046
	ex	(sp), hl
	jr	00110$
;src/main.c:149: case 2: init = 90;break;
00109$:
	ld	hl,#0x005A
	ex	(sp), hl
;src/main.c:150: }
00110$:
;src/main.c:151: memptr = cpct_getScreenPtr(VMEM,15,init);
	ld	h,-6 (ix)
	push	bc
	push	de
	push	hl
...
;src/main.c:116: cpct_drawStringM0("Lounge Gladiator",memptr,1,0);
	ld	-2 (ix),l
	ld	-1 (ix),h
;src/main.c:152: cpct_drawSolidBox(memptr, 3, 2, 8);
	push	bc
	push	de
	ld	hl,#0x0802
	push	hl
...
;src/main.c:154: switch (pushed){
	...
	add	hl,de
	add	hl,de
;src/main.c:155: case 0: return 1;break;
	jp	(hl)
00167$:
	jr	00111$
	jr	00112$
...
00111$:
	ld	hl,#0x0001
	jr	00120$
;src/main.c:156: case 1: return 2;break;
00112$:
	ld	hl,#0x0002
	jr	00120$
;src/main.c:157: case 2: return 0;break;
00113$:
	ld	hl,#0x0000
	jr	00120$
;src/main.c:158: }
...
; ---------------------------------
_game::
;src/main.c:175: initVariables();
	call	_initVariables
;src/main.c:176: initPlayer(map);
	ld	a,(_map)
	push	af
	inc	sp
	call	_initPlayer
	inc	sp
;src/main.c:177: initNivel();
	call	_initNivel
;src/main.c:178: initEnemies(map);
	ld	a,(_map)
	push	af
	inc	sp
	call	_initEnemies
	inc	sp
;src/main.c:181: cpct_clearScreen(0);
	ld	hl,#0x4000
	push	hl
	xor	a, a
	push	af
	...
	push	hl
	call	_cpct_memset
;src/main.c:182: drawMap(map);
	ld	a,(_map)
	push	af
	inc	sp
	call	_drawMap
	inc	sp
;src/main.c:184: while (1){
00137$:
;src/main.c:187: cpct_waitVSYNC();
	call	_cpct_waitVSYNC
;src/main.c:190: erases();
	call	_erases
;src/main.c:193: if(temp == 10)
	ld	a,(#_temp + 0)
	sub	a, #0x0A
	jr	NZ,00102$
;src/main.c:194: drawPickUps(n.corazon,n.bullet);
	ld	hl, #(_n + 0x0002) + 0
	ld	d,(hl)
	ld	a, (#(_n + 0x0001) + 0)
	push	de
	...
	pop	af
00102$:
;src/main.c:197: draws();
	call	_draws
;src/main.c:200: if(temp == 10){
	ld	a,(#_temp + 0)
	sub	a, #0x0A
	jr	NZ,00110$
;src/main.c:201: if(player.atk < 20) drawFatiga(player.atk,2);
	ld	hl, #(_player + 0x0008) + 0
	ld	d,(hl)
	ld	a,d
	sub	a, #0x14
	...
	jr	00110$
00107$:
;src/main.c:202: else if(player.atk > 20) drawFatiga(player.atk,1);
	ld	a,#0x14
	sub	a, d
	jr	NC,00104$
	ld	a,#0x01
	...
	jr	00110$
00104$:
;src/main.c:203: else drawFatiga(player.atk,0);
	xor	a, a
	push	af
	inc	sp
	push	de
	...
	pop	af
00110$:
;src/main.c:208: if(temp%2 == 0){
	ld	a,(#_temp + 0)
;src/main.c:209: player.lx = player.x;
;src/main.c:210: player.ly = player.y;
;src/main.c:208: if(temp%2 == 0){
	and	a,#0x01
	jr	NZ,00112$
;src/main.c:209: player.lx = player.x;
...
;src/main.c:210: player.ly = player.y;
	...
	ld	(#(_player + 0x0003)),a
00112$:
;src/main.c:213: if(enemy.life > 0){
	ld	hl, #(_enemy + 0x0008) + 0
	ld	l,(hl)
;src/main.c:216: enemy.ly = enemy.y;
;src/main.c:224: enemy.x = enemy.ox;
;src/main.c:225: enemy.y = enemy.oy;
;src/main.c:213: if(enemy.life > 0){
	ld	a,l
	or	a, a
	jp	Z,00119$
;src/main.c:214: if(temp%2 == 1){
	ld	a,(#_temp + 0)
	and	a, #0x01
	ld	h,a
;src/main.c:215: enemy.lx = enemy.x;
;src/main.c:216: enemy.ly = enemy.y;
;src/main.c:214: if(temp%2 == 1){
	dec	h
	jr	NZ,00114$
...
;src/main.c:219: move();
	call	_move
;src/main.c:221: switch(checkCollisions(player.x, player.y, enemy.x, enemy.y, player.atk)){
	ld	hl, #(_player + 0x0008) + 0
	ld	d,(hl)
	ld	a, (#(_enemy + 0x0001) + 0)
	ld	hl, #_enemy + 0
...
00115$:
;src/main.c:223: erase(enemy.lx,enemy.ly,0);
...
;src/main.c:225: enemy.y = enemy.oy;
	...
	ld	hl,#(_enemy + 0x0001)
	ld	(hl),e
;src/main.c:226: enemy.lx = enemy.x;
	ld	(#(_enemy + 0x0002)),a
;src/main.c:227: enemy.ly = enemy.y;
	ld	hl,#(_enemy + 0x0003)
	ld	(hl),e
;src/main.c:228: enemy.life -= 1;
	ld	a, (#(_enemy + 0x0008) + 0)
	add	a,#0xFF
	ld	(#(_enemy + 0x0008)),a
;src/main.c:229: player.atk = 20;
	ld	hl,#(_player + 0x0008)
	ld	(hl),#0x14
;src/main.c:230: break;
	jr	00119$
;src/main.c:231: case 2:
00116$:
;src/main.c:232: erase(player.lx,player.ly,0);
	...
	pop	af
	inc	sp
;src/main.c:233: player.x = 0;
	ld	hl,#_player
	ld	(hl),#0x00
;src/main.c:234: player.y = 80;
	ld	hl,#(_player + 0x0001)
	ld	(hl),#0x50
;src/main.c:235: player.lx = 0;
	ld	hl,#(_player + 0x0002)
	ld	(hl),#0x00
;src/main.c:236: player.ly = 80;
	ld	hl,#(_player + 0x0003)
	ld	(hl),#0x50
;src/main.c:237: player.life -= 1;
	ld	a, (#(_player + 0x0006) + 0)
	add	a,#0xFF
	ld	(#(_player + 0x0006)),a
;src/main.c:238: player.atk = 20;
	ld	hl,#(_player + 0x0008)
	ld	(hl),#0x14
;src/main.c:239: enemy.pursue = 0;
	ld	hl,#_enemy + 14
	ld	(hl),#0x00
;src/main.c:241: }
00119$:
;src/main.c:243: if(temp > 10)
	ld	a,#0x0A
	ld	iy,#_temp
	sub	a, 0 (iy)
	jr	NC,00121$
;src/main.c:244: temp = 0;
	ld	iy,#_temp
	ld	0 (iy),#0x00
00121$:
;src/main.c:245: temp += 1;
	ld	iy,#_temp
	inc	0 (iy)
;src/main.c:246: player.latk = player.atk;
	ld	de,#_player + 9
	ld	a, (#(_player + 0x0008) + 0)
	ld	(de),a
;src/main.c:249: cpct_scanKeyboard_f();
	call	_cpct_scanKeyboard_f
;src/main.c:250: player.sprite = checkKeyboard();
	call	_checkKeyboard
	ld	e,l
	ld	d,h
	ld	((_player + 0x0004)), de
;src/main.c:251: checkBoundsCollisions(&n.corazon,&n.bullet);
	ld	hl,#(_n + 0x0002)
	ld	de,#(_n + 0x0001)
	push	hl
	push	de
	...
	pop	af
	pop	af
;src/main.c:253: if(arrow == 1){
	ld	a,(#_arrow + 0)
	dec	a
	jr	NZ,00131$
;src/main.c:254: moveObject();
	call	_moveObject
;src/main.c:255: bound = checkArrowCollisions();
	call	_checkArrowCollisions
	ld	iy,#_bound
	ld	0 (iy),l
;src/main.c:256: if(object.dir == 2 || object.dir == 8)
	ld	hl, #_object + 7
	ld	a, (hl)
	cp	a,#0x02
	jr	Z,00122$
	...
	jr	NZ,00123$
00122$:
;src/main.c:257: atkObj = 21;
	ld	b,#0x15
	jr	00124$
00123$:
;src/main.c:259: atkObj = 22;
	ld	b,#0x16
00124$:
;src/main.c:260: if(enemy.life > 0 && checkCollisions(object.x, object.y, enemy.x, enemy.y, atkObj) == 1 && bound == 0){
	ld	a, (#(_enemy + 0x0008) + 0)
	or	a, a
	jr	Z,00131$
	ld	a, (#(_enemy + 0x0001) + 0)
	...
	or	a, a
	jr	NZ,00131$
;src/main.c:261: enemy.life -= 1;
	ld	a, (#(_enemy + 0x0008) + 0)
	add	a,#0xFF
	ld	(#(_enemy + 0x0008)),a
;src/main.c:262: enemy.x = enemy.ox;
	ld	a, (#(_enemy + 0x0004) + 0)
	ld	(#_enemy),a
;src/main.c:263: enemy.y = enemy.oy;
	ld	a, (#(_enemy + 0x0005) + 0)
	ld	(#(_enemy + 0x0001)),a
;src/main.c:264: object.vivo = 0;
	ld	hl,#_object + 6
	ld	(hl),#0x00
;src/main.c:265: bound = 1;
	ld	iy,#_bound
	ld	0 (iy),#0x01
00131$:
;src/main.c:269: if(player.life == 0){
	ld	a, (#(_player + 0x0006) + 0)
	or	a, a
	jr	NZ,00133$
;src/main.c:270: gameOver();
	call	_gameOver
;src/main.c:271: finish = 1;
	ld	hl,#_finish + 0
	ld	(hl), #0x01
00133$:
;src/main.c:273: if(finish == 1) return;
	ld	a,(#_finish + 0)
	dec	a
	jp	NZ,00137$
	ret
;src/main.c:280: void credits(){
;	---------------------------------
; Function credits
; ---------------------------------
_credits::
;src/main.c:282: cpct_clearScreen(0);
	...
	push	hl
	call	_cpct_memset
;src/main.c:283: memptr = cpct_getScreenPtr(VMEM,10,10);
	ld	hl,#0x0A0A
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:284: cpct_drawStringM0("Lounge Gladiator",memptr,1,0);
	ex	de,hl
	ld	bc,#___str_6
	push	de
	ld	hl,#0x0001
...
00104$:
;src/main.c:288: cpct_scanKeyboard_f();
	push	de
	call	_cpct_scanKeyboard_f
	pop	de
;src/main.c:289: cpct_drawStringM0("Josep Domenech Mingot",memptr,1,0);
	ld	bc,#___str_7
	push	de
	ld	hl,#0x0001
	push	hl
	...
	ld	sp,hl
	pop	de
;src/main.c:290: cpct_drawStringM0("Alberto Martinez Martinez",memptr,1,0);
	ld	bc,#___str_8
	push	de
	ld	hl,#0x0001
	push	hl
...
00106$:
;src/main.c:312: x=menu();
	call	_menu
	ld	e, l
	ld	d, h
;src/main.c:313: switch(x){
	bit	7, d
	jr	NZ,00106$
	ld	a,#0x02
	cp	a, e
...
00122$:
	...
	add	hl,de
	add	hl,de
;src/main.c:314: case 0: return;break;
;src/main.c:315: case 1: game(); break;
	jp	(hl)
00123$:
	jr	00108$
	jr	00102$
...
00102$:
	call	_game
	jr	00106$
;src/main.c:316: case 2: credits();break;
00103$:
	call	_credits
;src/main.c:317: }
	jr	00106$
