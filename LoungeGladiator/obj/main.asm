...
;src/main.c:508: }
	ret
;src/main.c:514: u8 followPlayer(u8 px,u8 py,u8 *x,u8 *y,u8 lx,u8 ly,u8 *dir,u8 room,u8 sizeX,u8 sizeY){
;	---------------------------------
...
_followPlayer::
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:516: dir[0] = setDirection(px,py,x[0],y[0]);
	ld	c,12 (ix)
	ld	b,13 (ix)
	ld	a,8 (ix)
	ld	-3 (ix),a
	...
	ld	a,d
	ld	(bc),a
;src/main.c:517: movement(dir[0],&x[0],&y[0]);
	ld	l,-3 (ix)
	ld	h,-2 (ix)
	push	hl
	ld	l,-10 (ix)
	...
	pop	af
	inc	sp
;src/main.c:518: if(scene[(y[0])/tileheight][(x[0])/tilewidth] == 1
	ld	l,-3 (ix)
	ld	h,-2 (ix)
	ld	a,(hl)
	ld	-8 (ix), a
	...
	dec	a
	jp	Z,00101$
;src/main.c:519: || scene[(y[0])/tileheight][(x[0]+sizeX-1)/tilewidth] == 1
	ld	l,-11 (ix)
	ld	h,#0x00
	ld	e,15 (ix)
	ld	d,#0x00
...
00108$:
	...
	dec	a
	jp	Z,00101$
;src/main.c:520: || scene[(y[0]+sizeY-2)/tileheight][(x[0])/tilewidth] == 1
	ld	l,-8 (ix)
	ld	h,#0x00
	ld	e,16 (ix)
	ld	d,#0x00
...
00109$:
	...
	dec	a
	jr	Z,00101$
;src/main.c:521: || scene[(y[0]+sizeY-2)/tileheight][(x[0]+sizeX-1)/tilewidth] == 1
	ld	a,-5 (ix)
	or	a, a
	jr	Z,00110$
	pop	bc
...
;src/main.c:524: *y=ly;
	...
	ld	(hl),a
00102$:
;src/main.c:527: return following;
	ld	l,#0x01
	ld	sp, ix
	pop	ix
	ret
;src/main.c:531: void patrol(u8 dir,u8 lx,u8 ly,u8 *x,u8 *y,u8 room,u8 sizeX,u8 sizeY){
;	---------------------------------
; Function patrol
; ---------------------------------
_patrol::
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:534: movement(dir,&x[0],&y[0]);
	ld	a,9 (ix)
	ld	-11 (ix),a
	ld	a,10 (ix)
	ld	-10 (ix),a
	...
	pop	af
	inc	sp
;src/main.c:536: if(scene[(y[0])/tileheight][(x[0])/tilewidth] != room
	ld	l,-11 (ix)
	ld	h,-10 (ix)
	ld	a,(hl)
	ld	-3 (ix), a
	...
	sub	a,(hl)
	jp	NZ,00101$
;src/main.c:537: || scene[(y[0])/tileheight][(x[0]+sizeX-1)/tilewidth] != room
	ld	l,-12 (ix)
	ld	h,#0x00
	ld	e,12 (ix)
	ld	d,#0x00
...
00108$:
	...
	sub	a,(hl)
	jp	NZ,00101$
;src/main.c:538: || scene[(y[0]+sizeY-2)/tileheight][(x[0])/tilewidth] != room
	ld	l,-3 (ix)
	ld	h,#0x00
	ld	e,13 (ix)
	ld	d,#0x00
...
00109$:
	...
	sub	a,(hl)
	jr	NZ,00101$
;src/main.c:539: || scene[(y[0]+sizeY-2)/tileheight][(x[0]+sizeX-1)/tilewidth] != room
	ld	a,-7 (ix)
	or	a, a
	jr	Z,00110$
	ld	c,-14 (ix)
...
00106$:
	...
	pop	ix
	ret
;src/main.c:547: u8 vissionSensor(u8 x,u8 y,u8 px,u8 py){
;	---------------------------------
...
_vissionSensor::
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:548: u8 following = 0;
	ld	-5 (ix),#0x00
;src/main.c:549: u8 cx = x/tilewidth;
	ld	a,4 (ix)
	rrca
	rrca
	and	a,#0x3F
	ld	-6 (ix),a
;src/main.c:550: u8 cy = y/tilewidth;
	ld	a,5 (ix)
	rrca
	rrca
	and	a,#0x3F
	ld	-3 (ix),a
;src/main.c:551: u8 pcx = px/tilewidth;
	ld	a,6 (ix)
	rrca
	rrca
	and	a,#0x3F
	ld	-7 (ix),a
;src/main.c:552: u8 pcy = py/tilewidth;
	ld	a,7 (ix)
	rrca
	rrca
	and	a,#0x3F
	ld	-1 (ix),a
;src/main.c:555: for(i=0;i<3;i++){
	ld	-4 (ix),#0x00
00107$:
;src/main.c:556: lex = cx - i;
	ld	a,-6 (ix)
	sub	a, -4 (ix)
	ld	-2 (ix),a
;src/main.c:557: ley = cy - i;
	ld	a,-3 (ix)
	sub	a, -4 (ix)
	ld	-9 (ix),a
;src/main.c:558: mex = cx + i;
	ld	a,-6 (ix)
	add	a, -4 (ix)
	ld	-8 (ix),a
;src/main.c:559: mey = cy + i;
	ld	a,-3 (ix)
	add	a, -4 (ix)
	ld	-10 (ix), a
	ld	d, a
;src/main.c:560: if(lex == pcx || ley == pcy || mex == pcx || mey == pcy){
	ld	a,-2 (ix)
	sub	a, -7 (ix)
	jr	Z,00101$
	ld	a,-9 (ix)
...
;src/main.c:555: for(i=0;i<3;i++){
	...
	sub	a, #0x03
	jr	C,00107$
;src/main.c:565: return following;
	ld	l,-5 (ix)
	ld	sp, ix
	pop	ix
	ret
;src/main.c:570: u8* move(u8 *x,u8 *y,u8 lx, u8 ly,u8 sizeX,u8 sizeY,u8 *dir,u8 *s,u8 room,u8 px,u8 py,u8 *following){
;	---------------------------------
; Function move
; ---------------------------------
_move::
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:571: u8 *sprite = s;
	ld	a,14 (ix)
	ld	-23 (ix),a
	ld	a,15 (ix)
	ld	-22 (ix),a
;src/main.c:574: dir[0] = chooseDirection(dir[0]);
	ld	a,12 (ix)
	ld	-14 (ix),a
	ld	a,13 (ix)
	ld	-13 (ix),a
;src/main.c:573: if(temp > 36){
	ld	a,#0x24
	ld	iy,#_temp
	cp	a, 0 (iy)
	ld	a,#0x00
...
;src/main.c:574: dir[0] = chooseDirection(dir[0]);
	...
	ld	h,-13 (ix)
	ld	(hl),a
;src/main.c:575: temp = 0;
	ld	hl,#0x0000
	ld	(_temp),hl
	jp	00116$
00115$:
;src/main.c:578: if(temp%6== 0){
	ld	hl,#0x0006
	push	hl
	ld	hl,(_temp)
	push	hl
	...
	or	a,l
	jp	NZ,00116$
;src/main.c:579: detected = detectPlayerRoom(px,py,room);
	ld	h,16 (ix)
	ld	l,18 (ix)
	push	hl
	ld	a,17 (ix)
	...
	pop	af
	inc	sp
;src/main.c:581: if(following[0] == 1){
	ld	a,19 (ix)
	ld	-16 (ix),a
	ld	a,20 (ix)
	ld	-15 (ix),a
;src/main.c:582: followPlayer(px,py,&x[0],&y[0],lx,ly,&dir[0],room,sizeX,sizeY);
	ld	a,6 (ix)
	ld	-3 (ix),a
	ld	a,7 (ix)
	ld	-2 (ix),a
...
;src/main.c:582: followPlayer(px,py,&x[0],&y[0],lx,ly,&dir[0],room,sizeX,sizeY);
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:583: following[0] = vissionSensor(x[0],y[0],px,py);
	ld	l,-3 (ix)
	ld	h,-2 (ix)
	ld	b,(hl)
	ld	l,-21 (ix)
	...
	jp	00116$
00107$:
;src/main.c:585: if(scene[(y[0])/tileheight][(x[0]+sizeX-1)/tilewidth] != 0
	ld	l,-3 (ix)
	ld	h,-2 (ix)
	ld	a,(hl)
	ld	-1 (ix), a
...
00119$:
	...
	or	a, a
	jp	NZ,00101$
;src/main.c:586: || scene[(y[0]+sizeY-2)/tileheight][(x[0])/tilewidth] != 0
	ld	a,-1 (ix)
	ld	-9 (ix),a
	ld	-8 (ix),#0x00
	ld	a,11 (ix)
...
00120$:
	...
	or	a, a
	jp	NZ,00101$
;src/main.c:587: || scene[(y[0]+sizeY-2)/tileheight][(x[0]+sizeX-1)/tilewidth] != 0){
	ld	a,-7 (ix)
	ld	-5 (ix),a
	ld	a,-6 (ix)
	ld	-4 (ix),a
...
00122$:
	...
	jr	Z,00102$
00101$:
;src/main.c:588: patrol(dir[0],lx,ly,&x[0],&y[0],room,sizeX,sizeY);
	ld	l,-14 (ix)
	ld	h,-13 (ix)
	ld	d,(hl)
	ld	h,11 (ix)
	...
	jr	00116$
00102$:
;src/main.c:592: x[0] = 52;
	ld	l,-21 (ix)
	ld	h,-20 (ix)
	ld	(hl),#0x34
;src/main.c:593: y[0] = 80;
	ld	l,-3 (ix)
	ld	h,-2 (ix)
	ld	(hl),#0x50
	jr	00116$
00110$:
;src/main.c:601: following[0] = followPlayer(px,py,&x[0],&y[0],lx,ly,&dir[0],room,sizeX,sizeY);
	ld	h,11 (ix)
	ld	l,10 (ix)
	push	hl
	ld	a,16 (ix)
...
;src/main.c:606: temp += 2;
	...
	adc	a, #0x00
	ld	(hl),a
;src/main.c:607: return sprite;
	pop	hl
	push	hl
	ld	sp, ix
	pop	ix
	ret
;src/main.c:614: void game(){
;	---------------------------------
; Function game
; ---------------------------------
_game::
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:615: TPlayer p = {0,80,0,80,gladis_quieto_dcha,3,6,4,16,4,20,20,3,0,0};
	ld	hl,#0x0003
	add	hl,sp
	ld	(hl),#0x00
	ld	hl,#0x0003
	...
	ld	h,a
	ld	(hl),#0x00
;src/main.c:616: TPlayer e = {52,80,52,80,chacho_dcha,3,6,4,16,4,0,0,0,1,3};
	ld	hl,#0x0013
	add	hl,sp
	ld	(hl),#0x34
	ld	hl,#0x0013
...
;src/main.c:617: TNivel n = {0,0,0};
	...
	ld	h,-44 (ix)
	ld	(hl),#0x00
;src/main.c:623: u8 finish = 0,i=1,arrow=0,following = 0;
	ld	-96 (ix),#0x00
	ld	-95 (ix),#0x00
	ld	-97 (ix),#0x00
;src/main.c:625: u8 bound =0;
	ld	-21 (ix),#0x00
;src/main.c:626: temp = 0;
	ld	hl,#0x0000
	ld	(_temp),hl
...
;src/main.c:633: while (1){
	...
	ld	-60 (ix),a
00144$:
;src/main.c:636: cpct_waitVSYNC();
	call	_cpct_waitVSYNC
;src/main.c:639: erasePlayer(p.lx,p.ly,0);
	ld	l,-53 (ix)
	ld	h,-52 (ix)
	ld	b,(hl)
	ld	l,-18 (ix)
	...
	pop	af
	inc	sp
;src/main.c:640: erasePlayer(e.lx,e.ly,0);
	ld	l,-6 (ix)
	ld	h,-5 (ix)
	ld	b,(hl)
	ld	l,-4 (ix)
	...
	pop	af
	inc	sp
;src/main.c:641: if(arrow == 1){
	ld	a,-95 (ix)
	dec	a
	jr	NZ,00108$
;src/main.c:642: if(object.dir == 4 || object.dir == 6)
	ld	hl, #(_object + 0x0007) + 0
	ld	e,(hl)
;src/main.c:643: erasePlayer(object.lx,object.ly,2);
...
;src/main.c:643: erasePlayer(object.lx,object.ly,2);
	...
	jr	00103$
00102$:
;src/main.c:645: erasePlayer(object.lx,object.ly,1);
	ld	a,#0x01
	push	af
	inc	sp
	ld	c, d
	...
	inc	sp
00103$:
;src/main.c:646: if(bound == 1) arrow = 0;
	ld	a,-21 (ix)
	dec	a
	jr	NZ,00108$
	ld	-95 (ix),#0x00
00108$:
;src/main.c:650: drawPickUps(n.corazon,n.bullet);
	ld	l,-45 (ix)
	ld	h,-44 (ix)
	ld	b,(hl)
	ld	l,-43 (ix)
	...
	call	_drawPickUps
	pop	af
;src/main.c:653: drawPlayer(p.x,p.y,p.sprite,p.life,0);
	ld	l,-59 (ix)
	ld	h,-58 (ix)
	ld	b,(hl)
	ld	l,-20 (ix)
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:654: if(e.life > 0) drawPlayer(e.x,e.y,e.sprite,e.life,0);
	ld	l,-82 (ix)
	ld	h,-81 (ix)
	ld	c,(hl)
	ld	a,c
	...
	ld	sp,hl
00110$:
;src/main.c:655: if(arrow == 1){
	ld	a,-95 (ix)
	dec	a
	jr	NZ,00119$
;src/main.c:656: if(object.dir == 4 || object.dir == 6)
	ld	hl, #(_object + 0x0007) + 0
	ld	h,(hl)
	ld	a,h
	cp	a,#0x04
	...
	jr	NZ,00115$
00114$:
;src/main.c:657: drawPlayer(object.x,object.y,object.sprite,object.vivo,2);
	...
	jr	00119$
00115$:
;src/main.c:658: else if(object.dir == 2 || object.dir == 8)
	ld	a,h
	cp	a,#0x02
	jr	Z,00111$
	sub	a, #0x08
	jr	NZ,00119$
00111$:
;src/main.c:659: drawPlayer(object.x,object.y,object.sprite,object.vivo,1);
	ld	hl, #(_object + 0x0006) + 0
	ld	e,(hl)
	ld	bc, (#(_object + 0x0004) + 0)
	ld	a,(#(_object + 0x0001) + 0)
	...
	ld	sp,hl
00119$:
;src/main.c:664: drawVida(p.life);
	ld	l,-59 (ix)
	ld	h,-58 (ix)
	ld	h,(hl)
	push	hl
	...
	call	_drawVida
	inc	sp
;src/main.c:665: drawBullets(p.bullets);
	ld	l,-31 (ix)
	ld	h,-30 (ix)
	ld	h,(hl)
	push	hl
	...
	call	_drawBullets
	inc	sp
;src/main.c:668: if(p.atk < 20) drawFatiga(p.atk,2);
	ld	l,-57 (ix)
	ld	h,-56 (ix)
	ld	d,(hl)
	ld	a,d
	...
	jr	00125$
00124$:
;src/main.c:669: else if(p.atk > 20) drawFatiga(p.atk,1);
	ld	a,#0x14
	sub	a, d
	jr	NC,00121$
	ld	a,#0x01
	...
	jr	00125$
00121$:
;src/main.c:670: else drawFatiga(p.atk,0);
	xor	a, a
	push	af
	inc	sp
	push	de
...
;src/main.c:677: p.latk = p.atk;
	...
	ld	h,-1 (ix)
	ld	(hl),a
;src/main.c:678: p.lsize = p.sizeX;
	ld	l,-47 (ix)
	ld	h,-46 (ix)
	ld	a,(hl)
	ld	l,-55 (ix)
	ld	h,-54 (ix)
	ld	(hl),a
;src/main.c:681: cpct_scanKeyboard_f();
	call	_cpct_scanKeyboard_f
;src/main.c:682: p.sprite = checkKeyboard(&p.x,&p.y,&p.atk,&p.dir,p.sprite,&p.sizeX,&p.bullets,&finish,&arrow);
	ld	hl,#0x0025
	add	hl,sp
	ld	c, l
	ld	b, h
	...
	inc	hl
	ld	(hl),e
;src/main.c:683: checkBoundsCollisions(&p.x,&p.y,p.lx,p.ly,p.sizeX,p.sizeY,&p.life,&p.bullets,&n.corazon,&n.bullet);
	ld	c,-70 (ix)
	ld	b,-69 (ix)
	ld	e,-72 (ix)
	ld	d,-71 (ix)
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:684: if(e.life > 0)
	ld	l,-82 (ix)
	ld	h,-81 (ix)
	ld	a,(hl)
	or	a, a
	jp	Z,00127$
;src/main.c:685: e.sprite = move(&e.x,&e.y,e.lx,e.ly,e.sizeX,e.sizeY,&e.dir,e.sprite,e.room,p.x,p.y,&following);
	ld	hl,#0x0023
	add	hl,sp
	ld	-92 (ix),l
	ld	-91 (ix),h
	...
	ld	(hl),e
00127$:
;src/main.c:687: if(e.life > 0)
	ld	l,-82 (ix)
	ld	h,-81 (ix)
	ld	a, (hl)
	or	a, a
	jp	Z,00136$
;src/main.c:688: if(checkCollisions(p.x, p.y, e.x, e.y, p.atk) == 2){
	ld	l,-57 (ix)
	ld	h,-56 (ix)
	ld	a,(hl)
	ld	l,-35 (ix)
	...
	sub	a, #0x02
	jr	NZ,00133$
;src/main.c:689: p.x = 0;
	ld	l,-51 (ix)
	ld	h,-50 (ix)
	ld	(hl),#0x00
;src/main.c:690: p.y = 80;
	ld	l,-29 (ix)
	ld	h,-28 (ix)
	ld	(hl),#0x50
;src/main.c:691: p.life -= 1;
	ld	l,-59 (ix)
	ld	h,-58 (ix)
	ld	a,(hl)
	add	a,#0xFF
	...
	ld	h,-58 (ix)
	ld	(hl),a
;src/main.c:692: if(p.life == 0){
	or	a, a
	jr	NZ,00136$
;src/main.c:693: gameOver();
	call	_gameOver
;src/main.c:694: break;
	jp	00146$
00133$:
;src/main.c:696: }else if(checkCollisions(p.x, p.y, e.x, e.y, p.atk) == 1){
	ld	l,-57 (ix)
	ld	h,-56 (ix)
	ld	a,(hl)
	ld	l,-35 (ix)
	...
	dec	l
	jr	NZ,00136$
;src/main.c:697: e.life =0;
	ld	l,-82 (ix)
	ld	h,-81 (ix)
	ld	(hl),#0x00
00136$:
;src/main.c:701: if(arrow == 1){
	ld	a,-95 (ix)
	dec	a
	jp	NZ,00140$
;src/main.c:702: moveObject();
	call	_moveObject
;src/main.c:703: bound = checkBoundsCollisions(&object.x,&object.y,object.lx,object.ly,object.sizeX,object.sizeY,0,0,0,0);
	ld	hl, #_object + 9
	ld	e,(hl)
	ld	hl, #_object + 8
	ld	c,(hl)
	...
	ld	sp,iy
	ld	-21 (ix),l
;src/main.c:704: if(checkCollisions(object.x, object.y, e.x, e.y, 21) == 1){
	ld	l,-35 (ix)
	ld	h,-34 (ix)
	ld	c,(hl)
	ld	l,-33 (ix)
	...
	dec	l
	jr	NZ,00140$
;src/main.c:705: e.life = 0;
	ld	l,-82 (ix)
	ld	h,-81 (ix)
	ld	(hl),#0x00
;src/main.c:706: object.vivo = 0;
	ld	hl,#(_object + 0x0006)
	ld	(hl),#0x00
00140$:
;src/main.c:710: if(finish == 1) return;
	ld	a,-96 (ix)
	dec	a
	jp	NZ,00144$
00146$:
	...
	pop	ix
	ret
;src/main.c:717: void credits(){
;	---------------------------------
; Function credits
; ---------------------------------
_credits::
;src/main.c:719: cpct_clearScreen(0);
	ld	hl,#0x4000
	push	hl
	xor	a, a
	push	af
	...
	push	hl
	call	_cpct_memset
;src/main.c:720: memptr = cpct_getScreenPtr(VMEM,10,10);
	ld	hl,#0x0A0A
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:721: cpct_drawStringM0("Lounge Gladiator",memptr,1,0);
	ex	de,hl
	ld	bc,#___str_5+0
	ld	hl,#0x0001
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:723: while (1){
00104$:
;src/main.c:725: cpct_scanKeyboard_f();
	call	_cpct_scanKeyboard_f
;src/main.c:729: if(cpct_isKeyPressed(Key_Esc)) {
	ld	hl,#0x0408
	call	_cpct_isKeyPressed
	ld	a,l
	or	a, a
	jr	Z,00104$
;src/main.c:731: return;
	ret
___str_5:
	.ascii "Lounge Gladiator"
	.db 0x00
;src/main.c:741: void main(void) {
;	---------------------------------
; Function main
; ---------------------------------
_main::
;src/main.c:745: init();
	call	_init
;src/main.c:748: while(1){
00106$:
;src/main.c:749: x=menu();
	call	_menu
	ld	e, l
	ld	d, h
;src/main.c:750: switch(x){
	bit	7, d
	jr	NZ,00106$
	ld	a,#0x02
	cp	a, e
...
00122$:
	...
	add	hl,de
	add	hl,de
;src/main.c:751: case 0: return;break;
;src/main.c:752: case 1: game(); break;
	jp	(hl)
00123$:
	jr	00108$
	jr	00102$
...
00102$:
	call	_game
	jr	00106$
;src/main.c:753: case 2: credits();break;
00103$:
	call	_credits
;src/main.c:754: }
	jr	00106$
