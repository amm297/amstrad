...
; This file was generated Fri Oct 23 16:55:16 2015
;--------------------------------------------------------
	.module main
	.optsdcc -mz80
...
;src/draws.h:16: cpct_drawStringM0("Congratulations",memptr,1,0);
	...
	add	hl,sp
	ld	sp,hl
;src/draws.h:18: memptr = cpct_getScreenPtr(VMEM, 12, 175); 
	ld	hl,#0xAF0C
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/draws.h:19: cpct_drawStringM0("Pulsa una tecla", memptr, 1, 0); 
	ex	de,hl
	ld	bc,#___str_1+0
	ld	hl,#0x0001
	push	hl
...
;src/CalcColision.h:28: popY = pY + auxY;
	...
	add	a, h
	ld	-6 (ix),a
;src/CalcColision.h:29: eopX = eX + 4;
	ld	e,6 (ix)
	inc	e
	inc	e
	inc	e
	inc	e
;src/CalcColision.h:30: eopY = eY + 16;
	ld	a,7 (ix)
	add	a, #0x10
	ld	-5 (ix),a
...
;src/main.c:46: cpct_drawStringM0("Lounge Gladiator",memptr,1,0);
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:48: memptr = cpct_getScreenPtr(VMEM,2,180);
	ld	hl,#0xB402
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:49: cpct_drawStringM0("Pulsa cualquier tecla",memptr,1,0);
	ex	de,hl
	ld	bc,#___str_3+0
	ld	hl,#0x0001
	push	hl
...
;src/main.c:52: cpct_scanKeyboard_f();
	call	_cpct_scanKeyboard_f
;src/main.c:53: if(cpct_isAnyKeyPressed()) return;
...
_menu::
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:60: int init = 50;
	ld	-4 (ix),#0x32
	ld	-3 (ix),#0x00
;src/main.c:61: int pushed =0;
	ld	de,#0x0000
;src/main.c:62: int cont =0;
	ld	hl,#0x0000
	ex	(sp), hl
;src/main.c:63: cpct_clearScreen(0);
	push	de
	ld	hl,#0x4000
	push	hl
	xor	a, a
	...
	call	_cpct_getScreenPtr
	pop	de
;src/main.c:66: cpct_drawSprite(portada1,memptr,60,60);
	ld	c, l
	ld	b, h
	push	de
	ld	hl,#0x3C3C
	...
	call	_cpct_getScreenPtr
	pop	de
;src/main.c:70: cpct_drawStringM0("Nueva Partida",memptr,1,0);
	ld	c, l
	ld	b, h
	push	de
	ld	hl,#0x0001
	...
	call	_cpct_getScreenPtr
	pop	de
;src/main.c:73: cpct_drawStringM0("Creditos",memptr,1,0);
	ld	c, l
	ld	b, h
	push	de
	ld	hl,#0x0001
	...
	call	_cpct_getScreenPtr
	pop	de
;src/main.c:76: cpct_drawStringM0("Constroles",memptr,1,0);
	ld	c, l
	ld	b, h
	push	de
	ld	hl,#0x0001
...
;src/main.c:66: cpct_drawSprite(portada1,memptr,60,60);
	ld	-2 (ix),l
	ld	-1 (ix),h
;src/main.c:79: cpct_drawStringM0("Salir",memptr,1,0);
	ld	bc,#___str_7
	push	de
	ld	hl,#0x0001
	push	hl
...
;src/main.c:89: cpct_drawSolidBox(memptr, 0, 2, 8);
	...
	inc	sp
	pop	de
;src/main.c:90: if(pushed<3) pushed ++;
	ld	a,e
	sub	a, #0x03
	ld	a,d
	rla
...
;src/main.c:91: cont =0;
	...
	ex	(sp), hl
00104$:
;src/main.c:93: if(cpct_isKeyPressed(Key_CursorUp) && cont > 150){
	push	de
	ld	hl,#0x0100
	call	_cpct_isKeyPressed
	ld	a,l
...
00177$:
	jp	P,00109$
;src/main.c:94: cpct_drawSolidBox(memptr, 0, 2, 8);
	push	de
	ld	hl,#0x0802
	push	hl
	xor	a, a
	...
	inc	sp
	pop	de
;src/main.c:95: if(pushed>0) pushed --;
	xor	a, a
	cp	a, e
	sbc	a, d
	jp	PO, 00178$
...
00178$:
	...
	dec	de
00107$:
;src/main.c:96: cont = 0;
	ld	hl,#0x0000
	ex	(sp), hl
00109$:
;src/main.c:99: switch (pushed){
	ld	a,d
	rlca
	and	a,#0x01
	ld	b,a
...
00179$:
	...
	add	hl,de
	add	hl,de
;src/main.c:100: case 0: init = 90;break;
	pop	de
	jp	(hl)
00180$:
	jr	00111$
...
00111$:
	...
	ld	-3 (ix),#0x00
	jr	00115$
;src/main.c:101: case 1: init = 110;break;
00112$:
	ld	-4 (ix),#0x6E
	ld	-3 (ix),#0x00
	jr	00115$
;src/main.c:102: case 2: init = 130;break;
00113$:
	ld	-4 (ix),#0x82
	ld	-3 (ix),#0x00
	jr	00115$
;src/main.c:103: case 3: init = 150;break;
00114$:
	ld	-4 (ix),#0x96
	ld	-3 (ix),#0x00
;src/main.c:104: }
00115$:
;src/main.c:105: memptr = cpct_getScreenPtr(VMEM,15,init);
	ld	h,-4 (ix)
	push	bc
	push	de
	push	hl
...
;src/main.c:66: cpct_drawSprite(portada1,memptr,60,60);
	ld	-2 (ix),l
	ld	-1 (ix),h
;src/main.c:106: cpct_drawSprite(marcador,memptr, 2, 8);
	push	bc
	push	de
	ld	hl,#0x0802
	push	hl
...
;src/main.c:108: switch (pushed){
	...
	add	hl,de
	add	hl,de
;src/main.c:109: case 0: return 1;break;
	jp	(hl)
00181$:
	jr	00116$
	jr	00117$
...
00116$:
	ld	hl,#0x0001
	jr	00126$
;src/main.c:110: case 1: return 2;break;
00117$:
	ld	hl,#0x0002
	jr	00126$
;src/main.c:111: case 2: return 3;break;
00118$:
	ld	hl,#0x0003
	jr	00126$
;src/main.c:112: case 3: return 0;break;
00119$:
	ld	hl,#0x0000
	jr	00126$
;src/main.c:113: }
...
___str_7:
	.ascii "Salir"
	.db 0x00
;src/main.c:121: void game(){
;	---------------------------------
; Function game
; ---------------------------------
_game::
;src/main.c:124: initVariables(1);
	ld	a,#0x01
	push	af
	inc	sp
	call	_initVariables
	inc	sp
;src/main.c:125: initPlayer(map);
	ld	a,(_map)
	push	af
	inc	sp
	call	_initPlayer
	inc	sp
;src/main.c:126: initNivel();
	call	_initNivel
;src/main.c:127: initEnemies(map);
	ld	a,(_map)
	push	af
	inc	sp
	call	_initEnemies
	inc	sp
;src/main.c:129: cpct_clearScreen(0);
	ld	hl,#0x4000
	push	hl
	xor	a, a
	push	af
...
00137$:
;src/main.c:132: if(finish == 1) return;
	ld	a,(#_finish + 0)
	dec	a
	ret	Z
	jr	00102$
...
;src/main.c:137: erases();
	call	_erases
;src/main.c:140: if(temp == 10)
	ld	a,(#_temp + 0)
	sub	a, #0x0A
	jr	NZ,00104$
;src/main.c:141: drawPickUps(n.corazon,n.bullet);
	ld	hl, #(_n + 0x0002) + 0
	ld	d,(hl)
	ld	a, (#(_n + 0x0001) + 0)
	push	de
	...
	pop	af
00104$:
;src/main.c:144: draws();
	call	_draws
;src/main.c:147: if(temp == 10){
	ld	a,(#_temp + 0)
	sub	a, #0x0A
	jr	NZ,00112$
;src/main.c:148: if(player.atk < 20) drawFatiga(player.atk,2);
	ld	hl, #(_player + 0x0008) + 0
	ld	d,(hl)
	ld	a,d
	sub	a, #0x14
	...
	jr	00112$
00109$:
;src/main.c:149: else if(player.atk > 20) drawFatiga(player.atk,1);
	ld	a,#0x14
	sub	a, d
	jr	NC,00106$
	ld	a,#0x01
	...
	jr	00112$
00106$:
;src/main.c:150: else drawFatiga(player.atk,0);
	xor	a, a
	push	af
	inc	sp
	push	de
...
;src/main.c:172: enemy.ly = enemy.y;
	ld	hl,#(_enemy + 0x0003)
	ld	(hl),d
;src/main.c:173: enemy.ox = originse[map-1][4];
	ld	hl,#_map + 0
	ld	d, (hl)
	dec	d
	ld	c,d
	...
	ld	a,(hl)
	ld	(#(_enemy + 0x0004)),a
;src/main.c:174: enemy.oy = originse[map-1][5];
	ld	hl,#_map + 0
	ld	d, (hl)
	dec	d
	ld	c,d
	...
	ld	a,(hl)
	ld	(#(_enemy + 0x0005)),a
;src/main.c:175: enemy.life -= 1;
	ld	a, (#(_enemy + 0x0008) + 0)
	add	a,#0xFF
	ld	(#(_enemy + 0x0008)),a
;src/main.c:176: player.atk = 20;
	ld	hl,#(_player + 0x0008)
	ld	(hl),#0x14
;src/main.c:177: enemy.pursue = 0;
	ld	hl,#(_enemy + 0x000d)
...
00118$:
;src/main.c:180: erase(player.lx,player.ly,0);
	...
	pop	af
	inc	sp
;src/main.c:181: player.x =originsp[map-1][0];
	ld	hl,#_map + 0
	ld	d, (hl)
	dec	d
	ld	l,d
	...
	ld	a,(hl)
	ld	(#_player),a
;src/main.c:182: player.y = originsp[map-1][1];
	ld	hl,#_map + 0
	ld	d, (hl)
	dec	d
	ld	l,d
	...
	ld	a,(hl)
	ld	(#(_player + 0x0001)),a
;src/main.c:183: player.lx =originsp[map-1][0];
	ld	hl,#_map + 0
	ld	d, (hl)
	dec	d
	ld	l,d
	...
	ld	a,(hl)
	ld	(#(_player + 0x0002)),a
;src/main.c:184: player.ly = originsp[map-1][1];
	ld	hl,#_map + 0
	ld	d, (hl)
	dec	d
	ld	l,d
	...
	ld	(hl),a
;src/main.c:185: player.life -= 1;
	ld	a, (#(_player + 0x0006) + 0)
	add	a,#0xFF
	ld	(#(_player + 0x0006)),a
;src/main.c:186: player.atk = 20;
	ld	hl,#(_player + 0x0008)
	ld	(hl),#0x14
;src/main.c:187: enemy.pursue = 0;
	ld	hl,#(_enemy + 0x000d)
	ld	(hl),#0x00
;src/main.c:189: }
00121$:
;src/main.c:191: if(temp > 10)
	ld	a,#0x0A
	ld	iy,#_temp
	sub	a, 0 (iy)
	jr	NC,00123$
;src/main.c:192: temp = 0;
	ld	iy,#_temp
	ld	0 (iy),#0x00
00123$:
;src/main.c:193: temp += 1;
	ld	iy,#_temp
	inc	0 (iy)
;src/main.c:194: player.latk = player.atk;
	ld	de,#_player + 9
	ld	a, (#(_player + 0x0008) + 0)
	ld	(de),a
...
;src/main.c:208: enemy.life -= 1;
	...
	add	a,#0xFF
	ld	(#(_enemy + 0x0008)),a
;src/main.c:209: erase(enemy.lx,enemy.ly,0);
	ld	hl, #(_enemy + 0x0003) + 0
	ld	b,(hl)
	ld	hl, #(_enemy + 0x0002) + 0
	ld	d,(hl)
...
;src/main.c:211: enemy.y = enemy.oy;
	...
	ld	(#(_enemy + 0x0001)),a
;src/main.c:212: enemy.lx = enemy.x;
	ld	hl,#(_enemy + 0x0002)
	ld	(hl),d
;src/main.c:213: enemy.ly = enemy.y;
	ld	(#(_enemy + 0x0003)),a
;src/main.c:214: enemy.pursue = 0;
	ld	hl,#(_enemy + 0x000d)
	ld	(hl),#0x00
;src/main.c:215: object.vivo = 0;
	ld	hl,#_object + 6
	ld	(hl),#0x00
;src/main.c:216: bound = 1;
	ld	iy,#_bound
	ld	0 (iy),#0x01
00133$:
;src/main.c:220: if(player.life == 0){
	ld	a, (#(_player + 0x0006) + 0)
	or	a, a
	jp	NZ,00137$
;src/main.c:221: gameOver();
	call	_gameOver
;src/main.c:222: finish = 1;
	ld	hl,#_finish + 0
	ld	(hl), #0x01
	jp	00137$
;src/main.c:231: void credits(){
;	---------------------------------
; Function credits
; ---------------------------------
_credits::
;src/main.c:233: cpct_clearScreen(0);
	ld	hl,#0x4000
	push	hl
	xor	a, a
	push	af
	...
	push	hl
	call	_cpct_memset
;src/main.c:235: memptr = cpct_getScreenPtr(VMEM, 18, 30);
	ld	hl,#0x1E12
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:236: cpct_drawStringM0("Grupo Pyxis", memptr, 1, 0);
	ex	de,hl
	ld	bc,#___str_8+0
	ld	hl,#0x0001
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:238: memptr = cpct_getScreenPtr(VMEM, 23, 60);
	ld	hl,#0x3C17
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:239: cpct_drawStringM0("Miembros:", memptr, 1, 0);
	ex	de,hl
	ld	bc,#___str_9+0
	ld	hl,#0x0001
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:241: memptr = cpct_getScreenPtr(VMEM, 10, 80);
	ld	hl,#0x500A
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:242: cpct_drawStringM0("Alberto Martinez", memptr,2, 0);
	ex	de,hl
	ld	bc,#___str_10+0
	ld	hl,#0x0002
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:243: memptr = cpct_getScreenPtr(VMEM, 27, 95);
	ld	hl,#0x5F1B
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:244: cpct_drawStringM0("Martinez", memptr,2, 0);
	ex	de,hl
	ld	bc,#___str_11+0
	ld	hl,#0x0002
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:246: memptr = cpct_getScreenPtr(VMEM, 13, 115);
	ld	hl,#0x730D
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:247: cpct_drawStringM0("Josep Domenech", memptr,2, 0);
	ex	de,hl
	ld	bc,#___str_12+0
	ld	hl,#0x0002
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:248: memptr = cpct_getScreenPtr(VMEM, 27, 125);
	ld	hl,#0x7D1B
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:249: cpct_drawStringM0("Mingot", memptr, 2, 0);
	ex	de,hl
	ld	bc,#___str_13+0
	ld	hl,#0x0002
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:251: memptr = cpct_getScreenPtr(VMEM, 12, 175);
	ld	hl,#0xAF0C
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:252: cpct_drawStringM0("Pulsa una esc", memptr, 1, 0);
	ex	de,hl
	ld	bc,#___str_14+0
	ld	hl,#0x0001
	push	hl
...
00104$:
;src/main.c:257: cpct_scanKeyboard_f();
	call	_cpct_scanKeyboard_f
;src/main.c:258: if(cpct_isKeyPressed(Key_Esc)) {
	ld	hl,#0x0408
	call	_cpct_isKeyPressed
	ld	a,l
	or	a, a
...
;src/main.c:271: cpct_clearScreen(0);
	...
	push	hl
	call	_cpct_memset
;src/main.c:273: memptr = cpct_getScreenPtr(VMEM, 23, 60);
	ld	hl,#0x3C17
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:274: cpct_drawStringM0("Controles:", memptr, 1, 0);
	ex	de,hl
	ld	bc,#___str_15+0
	ld	hl,#0x0001
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:276: memptr = cpct_getScreenPtr(VMEM, 11, 80);
	ld	hl,#0x500B
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:277: cpct_drawStringM0("Movimiento: ", memptr, 2, 0);
	ex	de,hl
	ld	bc,#___str_16+0
	ld	hl,#0x0002
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:278: memptr = cpct_getScreenPtr(VMEM, 27, 95);
	ld	hl,#0x5F1B
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:279: cpct_drawStringM0("Flechas", memptr, 2, 0);
	ex	de,hl
	ld	bc,#___str_17+0
	ld	hl,#0x0002
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:281: memptr = cpct_getScreenPtr(VMEM, 13, 115);
	ld	hl,#0x730D
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:282: cpct_drawStringM0("Esc: Menu", memptr, 2, 0);
	ex	de,hl
	ld	bc,#___str_18+0
	ld	hl,#0x0002
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:284: memptr = cpct_getScreenPtr(VMEM, 12, 175);
	ld	hl,#0xAF0C
	push	hl
	ld	hl,#0xC000
	push	hl
	call	_cpct_getScreenPtr
;src/main.c:285: cpct_drawStringM0("Pulsa una esc", memptr, 1, 0);
	ex	de,hl
	ld	bc,#___str_19+0
	ld	hl,#0x0001
	push	hl
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:287: while (1){
00104$:
;src/main.c:288: cpct_scanKeyboard_f();
	call	_cpct_scanKeyboard_f
;src/main.c:289: if(cpct_isKeyPressed(Key_Esc)) {
	ld	hl,#0x0408
	call	_cpct_isKeyPressed
	ld	a,l
	or	a, a
...
;src/main.c:301: init();
	call	_init
;src/main.c:304: while(1){
00107$:
;src/main.c:305: x=menu();
	call	_menu
	ld	e, l
	ld	d, h
;src/main.c:306: switch(x){
	bit	7, d
	jr	NZ,00107$
	ld	a,#0x03
	cp	a, e
...
00123$:
	...
	add	hl,de
	add	hl,de
;src/main.c:307: case 0: return;break;
;src/main.c:308: case 1: game(); break;
	jp	(hl)
00124$:
	jr	00109$
	jr	00102$
...
00102$:
	call	_game
	jr	00107$
;src/main.c:309: case 2: credits();break;
00103$:
	call	_credits
	jr	00107$
;src/main.c:310: case 3: controles();break;
00104$:
	call	_controles
;src/main.c:311: }
	jr	00107$
